...
#KEY0 = [0x0, 0x1, 0x2, 0x3]
#KEY1 = [0x4, 0x5, 0x6, 0x7]
#KEY2 = [0x8, 0x9, 0xa, 0xb]
#KEY3 = [0xc, 0xd, 0xe, 0xf]
#KEY4 = [0xf, 0xf, 0xf, 0xf]

""" ---------------------------------------- """



""" --- If you edit the variables below, you'll have to recompute the linear approximations --- """
""" --------------------------- Look to the README for more details --------------------------- """
